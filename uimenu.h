...
UI_MENU_ACTIONCOMMAND(ui_menu_home_all,UI_TEXT_HOME_ALL,UI_ACTION_HOME_ALL);  //  ------------------------------------------------------------------------- homepos. bleiben ----------------------------------------------------------------
...
#define UI_SPEED 2
#define UI_SPEED_X ,&ui_menu_go_xfast  //,&ui_menu_go_xpos  //----------------------------------------------------------------------------schnell = langsam ---------------------------------------------------------------------------------
...
#if DRIVE_SYSTEM != 3     //Positioning menu for non-delta    // #if DRIVE_SYSTEM != DELTA  FEHLER!!! --------------------------------------------------------------------------------------------------------------------------------------
...
UI_MENU(ui_menu_positions,UI_MENU_POSITIONS,2 + 3 * UI_SPEED + UI_MENU_BACKCNT);  //-----------------------------------------------------langsam raus ---------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------Extruder null setzen raus ------------------------------------------------------------------------------------------
#define UI_MENU_EXTRUDER {UI_MENU_ADDCONDBACK UI_MENU_BEDCOND UI_MENU_EXTCOND &ui_menu_go_epos}
UI_MENU(ui_menu_extruder,UI_MENU_EXTRUDER,UI_MENU_BACKCNT+UI_MENU_BEDCNT+UI_MENU_EXTCNT+1);
...
// Netzteil an/aus raus ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper}
//UI_MENU(ui_menu_quick,UI_MENU_QUICK,7+BABY_CNT+UI_MENU_BACKCNT+MENU_PSON_COUNT+DEBUG_PRINT_COUNT+UI_TOGGLE_LIGHT_COUNT);

// Netzteil an/aus raus, setze nullpunkt raus -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,&ui_menu_quick_stopstepper}
UI_MENU(ui_menu_quick,UI_MENU_QUICK,6+BABY_CNT+UI_MENU_BACKCNT+MENU_PSON_COUNT+DEBUG_PRINT_COUNT+UI_TOGGLE_LIGHT_COUNT);
...
#if DRIVE_SYSTEM != 3  // #if DRIVE_SYSTEM != DELTA  FEHLER!!! -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

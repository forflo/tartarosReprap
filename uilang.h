...
#define UI_TEXT_X_POS_FAST       "X Position"  // "X Pos. Fast" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Y Position"
#define UI_TEXT_Y_POS_FAST       "Y Position"  // "Y Pos. Fast" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Z Position"
#define UI_TEXT_Z_POS_FAST       "Z Position"  // "Z Pos. Fast" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_X_POSITION       "X Position"
#define UI_TEXT_X_POS_FAST       "X Position"  // "X Pos. Schnell" -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Y Position"
#define UI_TEXT_Y_POS_FAST       "Y Position"  // "Y Pos. Schnell" -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Z Position"
#define UI_TEXT_Z_POS_FAST       "Z Position"  // "Z Pos. Schnell" -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_E_POSITION       "Extr. Position"
#define UI_TEXT_BED_TEMP         "Bed Temp: %Eb\002C"
#define UI_TEXT_EXTR0_TEMP       "Temp. 1:  %E0\002C"
#define UI_TEXT_EXTR1_TEMP       "Temp. 2:  %E1\002C"
...
#define UI_TEXT_EXTR0_SELECT     "%X0 W" STR_auml "hle Extr. 1" 
#define UI_TEXT_EXTR1_SELECT     "%X1 W" STR_auml "hle Extr. 2"
#define UI_TEXT_EXTR2_SELECT     "%X2 W" STR_auml "hle Extr. 3"
...
#define UI_TEXT_X_POS_FAST       "X Positie"  // "X Pos. Snel" ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Y Positie"
#define UI_TEXT_Y_POS_FAST       "Y Positie"  // "Y Pos. Snel" ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Z Positie"
#define UI_TEXT_Z_POS_FAST       "Z Positie"  // "Z Pos. Snel" ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_X_POS_FAST       "Posicao X"  // "Pos. Rapida X" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Posicao Y"
#define UI_TEXT_Y_POS_FAST       "Posicao Y"  // "Pos. Rapida Y" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Posicao Z"
#define UI_TEXT_Z_POS_FAST       "Posicao Z"  // "Pos. Rapida Z" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_X_POS_FAST       "Posizione X"  // "Pos. X Veloce" --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Posizione Y"
#define UI_TEXT_Y_POS_FAST       "Posizione Y"  // "Pos. Y Veloce" --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Posizione Z"
#define UI_TEXT_Z_POS_FAST       "Posizione Z"  // "Pos. Z Veloce" --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_X_POS_FAST       "Posicion X"  // "Pos. Rapida X" ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Posicion Y"
#define UI_TEXT_Y_POS_FAST       "Posicion Y"  // "Pos. Rapida Y" ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Posicion Z"
#define UI_TEXT_Z_POS_FAST       "Posicion Z"  // "Pos. Rapida Z" ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_X_POSITION       "X-position"
#define UI_TEXT_X_POS_FAST       "X-position"  // "X-pos. snabb" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Y-position"
#define UI_TEXT_Y_POS_FAST       "Y-position"  // "Y-pos. snabb" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Z-osition"
#define UI_TEXT_Z_POS_FAST       "Z-osition"  // "Z-pos. snabb" -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_E_POSITION       "Extr.-position"
...
#define UI_TEXT_X_POS_FAST       "Position X"  // "Pos. Rapide X" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION       "Position Y"
#define UI_TEXT_Y_POS_FAST       "Position Y"  // "Pos. Rapide Y" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Z_POSITION       "Position Z"
#define UI_TEXT_Z_POS_FAST       "Position Z"  // "Pos. Rapide Z" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_TEXT_ACTION_XPOSITION4 "X:%x0 mm","Min Butée:%sx","Max Butée:%sX",""
#define UI_TEXT_ACTION_YPOSITION4 "Y:%x1 mm","Min Butée:%sy","Max Butée:%sY",""
#define UI_TEXT_ACTION_ZPOSITION4 "Z:%x2 mm","Min Butée:%sz","Max Butée:%sZ",""
#define UI_TEXT_ACTION_XPOSITION_FAST4 "X:%x0 mm","Min Butée:%sx","Max Butée:%sX",""
#define UI_TEXT_ACTION_YPOSITION_FAST4 "Y:%x1 mm","Min Butée:%sy","Max Butée:%sY",""
#define UI_TEXT_ACTION_ZPOSITION_FAST4 "Z:%x2 mm","Min Butée:%sz","Max Butée:%sZ",""
...
#define UI_TEXT_POWER               "ATX power on/off"
#define UI_TEXT_STRING_HM_DEADTIME  "Temps Mort"
#define UI_TEXT_STRING_HM_SLOWBANG  "SlowBang"
...
#define UI_TEXT_X_POS_FAST "X pozice"  //"X rychle" ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define UI_TEXT_Y_POSITION "Y pozice"
#define UI_TEXT_Y_POS_FAST "Y pozice"  //"Y rychle" 
#define UI_TEXT_Z_POSITION "Z pozice"
#define UI_TEXT_Z_POS_FAST "Z pozice"  //"Z rychle"

...
#define BABYSTEP_MULTIPLICATOR 40  // ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define FEATURE_FAN_CONTROL false  //true --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_AUTORETURN_TO_MENU_AFTER 0  // 30000
...
*/
#define UI_SPEEDDEPENDENT_POSITIONING false  //true ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_SET_EXTRUDER_RETRACT_DISTANCE 2 // mm
